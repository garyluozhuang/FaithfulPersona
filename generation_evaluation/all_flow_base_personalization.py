...
if __name__ == "__main__":
    ...
    folder_path = "./result/explanation/{}/base_personalization/{}/sample=".format(group, str(user_id)) + str(sample_num) + "/"
    ...
    if mode == "evaluate":
        ...
        evaluation_folder_path = "./result/evaluation/{}/k=".format(group) + str(evaluation_k) + "/base_personalization/{}/sample=".format(str(user_id)) + str(sample_num) + "/"
